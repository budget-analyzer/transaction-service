...
# Usage: ./gen-bkk-bank-statement-csv.sh [--clean] [--output-dir DIR] START_DATE END_DATE
...
main() {
    ...
    local output_file="${output_dir}/bkk-bank-statement-${start_date}-to-${end_date}${suffix}.csv"
